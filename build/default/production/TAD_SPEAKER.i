...
# 4 "TAD_SPEAKER.C" 2
# 16 "TAD_SPEAKER.C"
static unsigned char estat_spk = 0;
static unsigned char hTimer;
static unsigned long durada_tics;
static unsigned char tics_toggle;
static unsigned long proxima_commuta;

void Speaker_Init(void) {

    if (TI_NewTimer(&hTimer) == 0) {
